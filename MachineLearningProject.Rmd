...
df.rf
```
The out of bag error obtained is 0.22%, which is quite low.This is the same as the out of sample error.
...
The plot shows the mean decrease gini of the various predictors.
